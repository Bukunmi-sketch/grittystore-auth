      ...
      {input.payment_status == "unpaid" && input.payment_type == "" && (
        <div className="payment-content">
          <p className="placed-order">
            <FaInfoCircle /> Hi <span className="highlighted" style={{ fontSize: "1em", textTransform: "capitalize" }} >  {input.customers_firstname} {input.customers_lastname}</span>  You just placed an order of <span className="highlighted" style={{ fontSize: "1em" }}> NGN {input.amount.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')} </span> for
          ...
          >
            <div className="details-content">
              ...
              <div className="modal-content-p">
                ...
                <p>
                  <b> Amount: </b>NGN {input.amount.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')}
                </p>
                <p>
                  <b> Order Status: </b>
                  {input.order_status}
